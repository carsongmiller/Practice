...
void Spaceship::updateShip()
{
	...
	rightWingX = mainX + sqrt(41) * cos(141.34019 - angle);
	rightWingY = mainY - sqrt(41) * sin(141.34019 - angle);
...
double Spaceship::shipAngle()
{
	...
	else if (speedX > 0 && speedY > 0)	return (180/PI)*atan(speedX / speedY);			//quadrant1
	else if (speedX < 0 && speedY > 0)	return 180 + (180 / PI)*atan(speedX / speedY);	//quadrant2
	else if (speedX < 0 && speedY < 0)	return 180 + (180 / PI)*atan(speedX / speedY);	//quadrant3
	else if (speedX > 0 && speedY < 0)	return 360 + (180 / PI)*atan(speedX / speedY);	//quadtant4
}